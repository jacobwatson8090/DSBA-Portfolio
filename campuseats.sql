...
INSERT INTO `driver_ratings` VALUES (1,5,5),(2,5,5),(3,4,3),(4,5,3),(5,5,4),(6,4,4),(7,5,3);
...
INSERT INTO `ratings` VALUES (1,2,1),(2,5,2),(3,5,3),(4,5,4),(5,4,5),(6,3,6),(7,4,7),(8,5,8),(9,5,9),(10,5,10),(11,1,11),(12,2,12),(13,5,13),(14,5,14),(15,4,15),(16,3,16),(17,3,17),(18,4,18),(19,5,19),(20,5,20),(21,3,21),(22,3,22),(23,5,23),(24,5,24),(25,5,25),(26,4,26),(27,5,27),(28,1,28);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `restaurants_audit` AFTER INSERT ON `restaurant` FOR EACH ROW BEGIN
    INSERT INTO restaurant_audit VALUES
    (0,NEW.restaurant_id, NEW.location, NEW.restaurant_name, 
    "INSERTED", NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `restaurants_audit_update` AFTER UPDATE ON `restaurant` FOR EACH ROW BEGIN
    INSERT INTO restaurant_audit VALUES
    (0,OLD.restaurant_id, OLD.location, OLD.restaurant_name, 
    "UPDATED", NOW());
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
DROP TABLE IF EXISTS `restaurant_audit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `restaurant_audit` (
  ...
  `location` varchar(75) DEFAULT NULL,
  `restaurant_name` varchar(75) DEFAULT NULL,
  `type_of_change` varchar(75) DEFAULT NULL,
...
--
-- Dumping data for table `restaurant_audit`
--

LOCK TABLES `restaurant_audit` WRITE;
/*!40000 ALTER TABLE `restaurant_audit` DISABLE KEYS */;
INSERT INTO `restaurant_audit` VALUES (107,108,'Salisbury','Bojangles','INSERTED','2021-04-07 16:11:22'),(108,203,'2 Jake Alexander Blvd, Salisbury, NC 28144','Cook Out','INSERTED','2021-04-07 23:42:14'),(109,2,'6977 Adams Locks Suite 001\nErikastad, LA 55321-5793','Kerluke-Herman','UPDATED','2021-04-07 23:50:43'),(110,2,'1 Main Street, Salisbury, NC 28144','Kerluke-Herman','UPDATED','2021-04-08 16:31:03'),(111,204,'20 Jake Alexander Blvd, Salisbury, NC 28144','Cook Out','INSERTED','2021-04-08 16:32:40'),(112,2,'10 Main Street, Salisbury, NC 28144','Kerluke-Herman','UPDATED','2021-04-08 17:45:31'),(113,205,'20 Harris Blvd, Salisbury, NC 28144','Cook Out Charlotte','INSERTED','2021-04-08 17:49:52');
/*!40000 ALTER TABLE `restaurant_audit` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `restaurant_ratings` VALUES (1,2,3),(2,1,4),(3,2,5),(4,1,4),(5,2,5),(6,1,3),(7,1,1),(8,2,5);
...
-- Dump completed on 2021-06-13 23:39:15
